...
import img from "/Mercy-Chinwolk.jpg";
...
export default function ArtistPage() {
  ...
  return (
    <div className="  overflow-y-auto relative">
      ...
      {/* Artist img */}
      <div className="bg-img w-full h-40vh fixed -z-10 bg-cover bg-center bg-no-repeat"></div>

      {/* Artist name display section */}
      <section className="w-full h-40vh flex justify-center items-end bg-gradient-to-t from-black/80 ">
        ...
        <div className="bg-gradient-to-b from-yellow-800/30 from-10% to-balck to-80% z-20">
          ...
          <div className="flex items-center justify-between p-3 pl-4 pr-4  ">
            <div className="w-10 h-12 flex justify-center items-center border-2 rounded-lg border-neutral-500">
              <img src={img} className="w-8 h-10 rounded-md" />
            </div>
      ...
      {/*  */}
      <section className="h-screen w-full bg-black mt-0 p-2 pr-4  pl-4 pt-16">
        <div className=" h-9p">
          <button 
           className={` ${isMusic && "border-b-2 border-green-500 text-white"}  mr-6 text-base pb-2  text-neutral-400`}
           onClick={handleMusicClick}
          >Music</button>
          <button 
            className= {` ${isMerch && "border-b-2 border-green-500 text-white"} mr-6 text-base pb-2 text-neutral-400 `}
