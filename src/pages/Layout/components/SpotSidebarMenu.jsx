...
// Icos
import { BsPlus, BsClockHistory, BsGear, BsLightningCharge } from "react-icons/bs"

export default function SpotSidebarMenu({display, dimension}) {
  return (
    <div className= {`bg-neutral-900 shrink-0 duration-500 ${dimension}`} >
        <div className={`${display} `}>

            {/* User profile  */}
            <div className="h-24 border-b border-neutral-600 p-2 flex items-center">
              {/*  */}
